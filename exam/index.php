...
<body>
    ...
    <nav class="navbar navbar-expand-md sticky-top" style="background-color: rgba(0, 0, 0, 0.6);" >
        <a href="#" class="navbar-brand" style="color: white; font-weight: bold; font-size: 25px;">Online exam system</a>
    ...
    <header class="jumbotron back-image">
      <div class="heading">
        <h2 class="text-light font-weight-bold text-uppercase mb-5" style="padding-top: 80px;">Welcome to Online exam system</h2>
